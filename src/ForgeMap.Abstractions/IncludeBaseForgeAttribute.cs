...
public sealed class IncludeBaseForgeAttribute : Attribute
{
    ...
    /// </summary>
    /// <param name="baseSourceType">The source type of the base forge method.</param>
    /// <param name="baseDestinationType">The destination type of the base forge method.</param>
